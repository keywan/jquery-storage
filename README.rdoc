...
The cookieStorage does not yet support saving objects (other then Strings), but can use jQuery JSON Plugin
to work around that. jquery.cookie2 cookieStorage allows to store jsonstrings.
