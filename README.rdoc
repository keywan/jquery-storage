...
A feature-rich jQuery plugin for reading, writing and deleting objects.

== Goals

=== compatibility with jquery.cookie
It is full backward compatible with jquery.cookie. You can use it as easy replacement, if you have already 
used jquery.cookie for stroing statefull informations in the browser.
